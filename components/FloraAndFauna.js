        ...
        <div className={styles.hitSingle}>
            ...
            <div className={styles.stageRight}>
                <p>A browser-based idle farming game built in React. This was my first full-fledged project
                   to make use of the <a className={`${styles.noDeco} ${styles.textGreen}`}
                                         href={'https://reactjs.org/docs/context.html'}> React Context API</a> for tracking game state.
                   Completely hand-rolled from start to finish, Flora and Fauna was equally as fun to design as it was to build.
                </p>
